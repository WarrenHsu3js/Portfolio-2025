...
// node_modules/ecctrl/node_modules/leva/dist/vector-plugin-6f82aee9.esm.js
var import_react_dom = __toESM(require_react_dom());
var import_react = __toESM(require_react());

// node_modules/ecctrl/node_modules/leva/node_modules/zustand/esm/shallow.js
...
// node_modules/ecctrl/node_modules/leva/dist/leva.esm.js
var import_react_dom2 = __toESM(require_react_dom());
var import_react5 = __toESM(require_react());

// node_modules/ecctrl/node_modules/leva/node_modules/zustand/esm/index.js
...
// node_modules/ecctrl/node_modules/leva/node_modules/zustand/esm/middleware.js
...
function useDeepMemo(fn, deps) {
  return (0, import_react5.useMemo)(fn, useCompareMemoize(deps, true));
}
...
var useVisiblePaths = (store) => {
  const [paths, setPaths] = (0, import_react5.useState)(store.getVisiblePaths());
  (0, import_react5.useEffect)(() => {
...
function usePopin(margin = 3) {
  const popinRef = (0, import_react5.useRef)(null);
  const wrapperRef = (0, import_react5.useRef)(null);
  const [shown, setShow] = (0, import_react5.useState)(false);
  const show = (0, import_react5.useCallback)(() => setShow(true), []);
  const hide = (0, import_react5.useCallback)(() => setShow(false), []);
  (0, import_react5.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
...
function Color({
  ...
  const [initialRgb, setInitialRgb] = (0, import_react5.useState)(() => convertToRgb(value, format3));
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(ColorPreview, {
    ref: popinRef,
    active: shown,
    onClick: () => showPicker(),
    style: {
  ...
  }), shown && import_react5.default.createElement(Portal, null, import_react5.default.createElement(Overlay, {
    onPointerUp: hidePicker
  }), import_react5.default.createElement(PickerWrapper, {
    ref: wrapperRef,
    onMouseEnter: () => window.clearTimeout(timer.current),
    onMouseLeave: (e) => e.buttons === 0 && hideAfterDelay()
  }, import_react5.default.createElement(ColorPicker, {
    color: initialRgb,
    onChange: onUpdate
  }))));
}
function ColorComponent() {
  ...
  return import_react5.default.createElement(Row, {
    input: true
  }, import_react5.default.createElement(Label, null, label), import_react5.default.createElement(PickerContainer, null, import_react5.default.createElement(Color, {
    value,
    displayValue,
    onChange,
    onUpdate,
    settings
  }), import_react5.default.createElement(ValueInput, {
    value: displayValue,
    onChange,
    onUpdate
  })));
...
function Vector3dComponent() {
  ...
  return import_react5.default.createElement(Row, {
    input: true
  }, import_react5.default.createElement(Label, null, label), import_react5.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  }));
...
function Joystick({
  ...
  const outOfBoundsX = (0, import_react5.useRef)(0);
  const outOfBoundsY = (0, import_react5.useRef)(0);
  const stepMultiplier = (0, import_react5.useRef)(1);
  const [joystickShown, setShowJoystick] = (0, import_react5.useState)(false);
  const [isOutOfBounds, setIsOutOfBounds] = (0, import_react5.useState)(false);
  const [spanRef, set] = useTransform();
  const joystickeRef = (0, import_react5.useRef)(null);
  const playgroundRef = (0, import_react5.useRef)(null);
  (0, import_react5.useLayoutEffect)(() => {
    if (joystickShown) {
      const {
        top,
  ...
  const startOutOfBounds = (0, import_react5.useCallback)(() => {
  ...
  const endOutOfBounds = (0, import_react5.useCallback)(() => {
  ...
  return import_react5.default.createElement(JoystickTrigger, _extends({
    ref: joystickeRef
  }, bind()), joystickShown && import_react5.default.createElement(Portal, null, import_react5.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
  }, import_react5.default.createElement("div", null), import_react5.default.createElement("span", {
    ref: spanRef
  }))));
}
...
function Vector2dComponent() {
  ...
  return import_react5.default.createElement(Row, {
    input: true
  }, import_react5.default.createElement(Label, null, label), import_react5.default.createElement(Container$1, {
    withJoystick: !!settings.joystick
  }, settings.joystick && import_react5.default.createElement(Joystick, {
    value: displayValue,
    settings,
    onUpdate
  }), import_react5.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  })));
...
function ImageComponent() {
  ...
  const onDrop = (0, import_react5.useCallback)((acceptedFiles) => {
    if (acceptedFiles.length) onUpdate(acceptedFiles[0]);
  }, [onUpdate]);
  const clear = (0, import_react5.useCallback)((e) => {
    e.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
  ...
  return import_react5.default.createElement(Row, {
    input: true
  }, import_react5.default.createElement(Label, null, label), import_react5.default.createElement(ImageContainer, null, import_react5.default.createElement(ImagePreview, {
    ref: popinRef,
    hasImage: !!value,
  ...
  }), shown && !!value && import_react5.default.createElement(Portal, null, import_react5.default.createElement(Overlay, {
    onPointerUp: hide,
    style: {
      cursor: "pointer"
    }
  }), import_react5.default.createElement(ImageLargePreview, {
    ref: wrapperRef,
    style: {
      backgroundImage: `url(${value})`
    }
  })), import_react5.default.createElement(DropZone, getRootProps({
    isDragAccept
  }), import_react5.default.createElement("input", getInputProps()), import_react5.default.createElement(Instructions, null, isDragAccept ? "drop image" : "click or drop")), import_react5.default.createElement(Remove, {
    onClick: clear,
    disabled: !value
  })));
}
...
function IntervalSlider(_ref) {
  ...
  const minScrubberRef = (0, import_react5.useRef)(null);
  const maxScrubberRef = (0, import_react5.useRef)(null);
  const rangeWidth = (0, import_react5.useRef)(0);
  const scrubberWidth = useTh("sizes", "scrubberWidth");
  const bind = useDrag2(({
    event,
    first,
  ...
  return import_react5.default.createElement(RangeWrapper, _extends({
    ref
  }, bind()), import_react5.default.createElement(Range, null, import_react5.default.createElement(Indicator, {
    style: {
      left: minStyle,
      right: maxStyle
    }
  })), import_react5.default.createElement(Scrubber, {
    position: "left",
    ref: minScrubberRef,
    style: {
      left: minStyle
...
function IntervalComponent() {
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(Row, {
    input: true
  }, import_react5.default.createElement(Label, null, label), import_react5.default.createElement(Container2, null, import_react5.default.createElement(IntervalSlider, _extends({
    value: displayValue
  }, settings, {
    onDrag: onUpdate
  })), import_react5.default.createElement(Vector, {
...
function ControlInput(_ref) {
  ...
  return import_react5.default.createElement(InputContext.Provider, {
  ...
  }, import_react5.default.createElement(StyledInputWrapper$1, {
    disabled
  }, import_react5.default.createElement(Input, null)));
}
...
function Button({
  ...
  const store = useStoreContext();
  return import_react5.default.createElement(Row, null, import_react5.default.createElement(StyledButton, {
...
function ButtonGroup(props3) {
  ...
  return import_react5.default.createElement(Row, {
    input: !!label
  }, label && import_react5.default.createElement(Label, null, label), import_react5.default.createElement(StyledButtonGroup, null, Object.entries(opts).map(([label2, onClick]) => import_react5.default.createElement(StyledButtonGroupButton, {
    key: label2,
    onClick: () => onClick(store.get)
  }, label2))));
}
...
var MonitorCanvas = (0, import_react5.forwardRef)(function({
  initialValue
}, ref) {
  ...
  const [gradientTop, gradientBottom] = (0, import_react5.useMemo)(() => {
    return [w(fillColor).alpha(0.4).toRgbString(), w(fillColor).alpha(0.1).toRgbString()];
  }, [fillColor]);
  const points = (0, import_react5.useRef)([initialValue]);
  const min = (0, import_react5.useRef)(initialValue);
  const max = (0, import_react5.useRef)(initialValue);
  const raf = (0, import_react5.useRef)();
  const drawPlot = (0, import_react5.useCallback)((_canvas, _ctx) => {
    if (!_canvas) return;
    const {
      width,
      height
  ...
  (0, import_react5.useEffect)(() => () => cancelAnimationFrame(raf.current), []);
  return import_react5.default.createElement(Canvas2, {
    ref: canvas
  });
});
var parse = (val) => Number.isFinite(val) ? val.toPrecision(2) : val.toString();
var MonitorLog = (0, import_react5.forwardRef)(function({
  initialValue
}, ref) {
  const [val, set] = (0, import_react5.useState)(parse(initialValue));
  (0, import_react5.useImperativeHandle)(ref, () => ({
    frame: (v) => set(parse(v))
  }), []);
  return import_react5.default.createElement("div", null, val);
});
function getValue(o) {
...
function Monitor({
  ...
  const ref = (0, import_react5.useRef)();
  const initialValue = (0, import_react5.useRef)(getValue(objectOrFn));
  (0, import_react5.useEffect)(() => {
  ...
  return import_react5.default.createElement(Row, {
    ...
    align: "top"
  }, label), settings.graph ? import_react5.default.createElement(MonitorCanvas, {
    ref,
    initialValue: initialValue.current
  }) : import_react5.default.createElement(MonitorLog, {
    ref,
    initialValue: initialValue.current
  }));
}
...
var Control = import_react5.default.memo(({
  path
}) => {
  const [input, {
    set,
  ...
  if (type in SpecialInputs) {
    ...
    return import_react5.default.createElement(SpecialInputForType, _extends({
      label,
      path
    }, inputProps));
  }
  ...
  return import_react5.default.createElement(ControlInput, _extends({
    key: storeId + path,
    type,
    label,
    storeId,
...
function FolderTitle({
  ...
  return import_react5.default.createElement(StyledTitle, {
    onClick: () => toggle()
  }, import_react5.default.createElement(Chevron, {
    toggled
  }), import_react5.default.createElement("div", null, name));
}
var Folder = ({
  name,
  path,
  ...
  const [toggled, setToggle] = (0, import_react5.useState)(!collapsed);
  const folderRef = (0, import_react5.useRef)(null);
  ...
  return import_react5.default.createElement(StyledFolder, {
    ref: folderRef
  }, import_react5.default.createElement(FolderTitle, {
    name,
    toggled,
    toggle: () => setToggle((t) => !t)
  }), import_react5.default.createElement(TreeWrapper, {
    parent: newPath,
    tree,
    toggled
  }));
};
var TreeWrapper = import_react5.default.memo(({
  ...
  return import_react5.default.createElement(StyledWrapper, {
    ref: wrapperRef,
    isRoot: _isRoot,
    fill: _fill,
    flat: _flat
  }, import_react5.default.createElement(StyledContent, {
    ref: contentRef,
    isRoot: _isRoot,
    toggled
  }, entries.map(([key, value]) => isInput(value) ? import_react5.default.createElement(Control, {
    key: value.path,
    valueKey: value.valueKey,
    path: value.path
  }) : import_react5.default.createElement(Folder, {
    key,
    name: key,
    path: parent,
    tree: value
...
var FilterInput = import_react5.default.forwardRef(({
  setFilter,
  toggle
}, ref) => {
  const [value, set] = (0, import_react5.useState)("");
  const debouncedOnChange = (0, import_react5.useMemo)(() => debounce(setFilter, 250), [setFilter]);
  const clear = () => {
    setFilter("");
    set("");
  };
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(StyledFilterInput, {
    ref,
    value,
...
function TitleWithFilter({
  ...
  const [filterShown, setShowFilter] = (0, import_react5.useState)(false);
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(StyledTitleWithFilter, {
    ...
    width: 12,
    height: 8
  })), import_react5.default.createElement(TitleContainer, _extends({}, drag ? bind() : {}, {
    drag,
    filterEnabled
  }), title === void 0 && drag ? import_react5.default.createElement("svg", {
    width: "20",
    height: "10",
    viewBox: "0 0 28 14",
    xmlns: "http://www.w3.org/2000/svg"
    ...
    cy: "12",
    r: "2"
  })) : title), filterEnabled && import_react5.default.createElement(Icon, {
    active: filterShown,
    ...
    clipRule: "evenodd"
  })))), import_react5.default.createElement(FilterWrapper, {
    toggled: filterShown
  }, import_react5.default.createElement(FilterInput, {
    ref: inputRef,
    setFilter,
    toggle
  })));
...
function LevaRoot(_ref) {
  ...
  const computedSetToggle = (0, import_react5.useMemo)(() => {
  ...
  return import_react5.default.createElement(ThemeContext.Provider, {
    value: themeContext
  }, import_react5.default.createElement(LevaCore, _extends({
    store
  }, props3, {
...
var LevaCore = import_react5.default.memo(({
  store,
  rootClass,
  fill: _fill = false,
  flat: _flat = false,
  ...
  const tree = (0, import_react5.useMemo)(() => buildTree(paths, filter), [paths, filter]);
  ...
  globalStyles();
  return import_react5.default.createElement(PanelSettingsContext.Provider, {
    value: {
      hideCopyButton: _hideCopyButton
    }
  }, import_react5.default.createElement(StyledRoot, {
    ref: rootRef,
    className: rootClass,
    fill: _fill,
    flat: _flat,
  ...
  }, _titleBar && import_react5.default.createElement(TitleWithFilter, {
    onDrag: (point) => {
      set(point);
    ...
    filterEnabled,
    from: position
  }), shouldShow && import_react5.default.createElement(StoreContext.Provider, {
    value: store
  }, import_react5.default.createElement(TreeWrapper, {
    isRoot: true,
    fill: _fill,
...
function Leva(_ref) {
  ...
  return import_react5.default.createElement(LevaRoot, _extends({
    store: levaStore
  }, props3));
}
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react5.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  const depsChanged = (0, import_react5.useRef)(false);
  const firstRender = (0, import_react5.useRef)(true);
  ...
  const [store] = (0, import_react5.useState)(() => (hookSettings === null || hookSettings === void 0 ? void 0 : hookSettings.store) || levaStore);
  const [initialData, mappedPaths] = (0, import_react5.useMemo)(() => store.getDataFromSchema(_schema), [store, _schema]);
  const [allPaths, renderPaths, onChangePaths, onEditStartPaths, onEditEndPaths] = (0, import_react5.useMemo)(() => {
    const allPaths2 = [];
    const renderPaths2 = [];
  ...
  const paths = (0, import_react5.useMemo)(() => store.orderPaths(allPaths), [allPaths, store]);
  const values = useValuesForPath(store, renderPaths, initialData);
  const set = (0, import_react5.useCallback)((values2) => {
    const _values = Object.entries(values2).reduce((acc, [p, v]) => Object.assign(acc, {
      [mappedPaths[p].path]: v
    }), {});
    store.set(_values, false);
  }, [store, mappedPaths]);
  const get = (0, import_react5.useCallback)((path) => store.get(mappedPaths[path].path), [store, mappedPaths]);
  (0, import_react5.useEffect)(() => {
...
// node_modules/ecctrl/node_modules/zustand/esm/react.mjs
...
var useFollowCam = function({
  ...
  const originZDis = (0, import_react9.useRef)(camInitDis != null ? camInitDis : -5);
  const pivot = (0, import_react9.useMemo)(() => new Object3D(), []);
  const followCam = (0, import_react9.useMemo)(() => {
  ...
  let intersects = null;
  const intersectObjects = (0, import_react9.useRef)([]);
  const cameraRayDir = (0, import_react9.useMemo)(() => new Vector3(), []);
  const cameraRayOrigin = (0, import_react9.useMemo)(() => new Vector3(), []);
  const cameraPosition = (0, import_react9.useMemo)(() => new Vector3(), []);
  const camLerpingPoint = (0, import_react9.useMemo)(() => new Vector3(), []);
...
var useJoystickControls = create2(
  subscribeWithSelector2((set, get) => {
    return {
      /**
...
function EcctrlAnimation(props3) {
  const group = (0, import_react9.useRef)();
  ...
  return import_react9.default.createElement(import_react9.Suspense, { fallback: null }, import_react9.default.createElement("group", { ref: group, dispose: null, userData: { camExcludeCollision: true } }, props3.children));
}
var JoystickComponents = (props3) => {
  ...
  let joystickDis = 0;
  let joystickAng = 0;
  const touch1MovementVec2 = (0, import_react9.useMemo)(() => new Vector2(), []);
  const joystickMovementVec2 = (0, import_react9.useMemo)(() => new Vector2(), []);
  const [windowSize, setWindowSize] = (0, import_react9.useState)({ innerHeight, innerWidth });
  ...
  const joystickBaseGeo = (0, import_react9.useMemo)(() => new CylinderGeometry(2.3, 2.1, 0.3, 16), []);
  const joystickStickGeo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.3, 0.3, 3, 6), []);
  const joystickHandleGeo = (0, import_react9.useMemo)(() => new SphereGeometry(1.4, 8, 8), []);
  const joystickBaseMaterial = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickStickMaterial = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickHandleMaterial = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.7 }), []);
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const onTouchMove = (0, import_react9.useCallback)((e) => {
    var _a;
    e.preventDefault();
    e.stopImmediatePropagation();
    const touch1 = e.targetTouches[0];
    ...
    const runState = joystickDis > joystickMaxDis * ((_a = props3.joystickRunSensitivity) != null ? _a : 0.9);
    api.start({
  ...
  return import_react9.default.createElement(import_react9.Suspense, { fallback: "null" }, import_react9.default.createElement(animated.group, { "position-x": springs.basePositionX, "position-y": springs.basePositionY }, import_react9.default.createElement("mesh", { geometry: joystickBaseGeo, material: joystickBaseMaterial, rotation: [-Math.PI / 2, 0, 0], ...props3.joystickBaseProps })), import_react9.default.createElement(animated.group, { "rotation-x": springs.topRotationX, "rotation-y": springs.topRotationY }, import_react9.default.createElement("mesh", { geometry: joystickStickGeo, material: joystickStickMaterial, rotation: [-Math.PI / 2, 0, 0], position: [0, 0, 1.5], ...props3.joystickStickProps }), import_react9.default.createElement("mesh", { geometry: joystickHandleGeo, material: joystickHandleMaterial, position: [0, 0, 4], ...props3.joystickHandleProps })));
};
var ButtonComponents = ({ buttonNumber = 1, ...props3 }) => {
  const buttonLargeBaseGeo = (0, import_react9.useMemo)(() => new CylinderGeometry(1.1, 1, 0.3, 16), []);
  const buttonSmallBaseGeo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.9, 0.8, 0.3, 16), []);
  const buttonTop1Geo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop2Geo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop3Geo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop4Geo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop5Geo = (0, import_react9.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonBaseMaterial = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const buttonTop1Material = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop2Material = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop3Material = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop4Material = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop5Material = (0, import_react9.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  ...
  return import_react9.default.createElement(import_react9.Suspense, { fallback: "null" }, buttonNumber > 0 && import_react9.default.createElement(
    animated.group,
    {
    ...
    import_react9.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(1) }),
    import_react9.default.createElement("mesh", { geometry: buttonTop1Geo, material: buttonTop1Material, position: [0, -0.3, 0], ...props3.buttonTop1Props })
  ), buttonNumber > 1 && import_react9.default.createElement(
    animated.group,
    {
    ...
    import_react9.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(2) }),
    import_react9.default.createElement("mesh", { geometry: buttonTop2Geo, material: buttonTop2Material, position: [0, -0.3, 0], ...props3.buttonTop2Props })
  ), buttonNumber > 2 && import_react9.default.createElement(
    animated.group,
    {
    ...
    import_react9.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(3) }),
    import_react9.default.createElement("mesh", { geometry: buttonTop3Geo, material: buttonTop3Material, position: [0, -0.3, 0], ...props3.buttonTop3Props })
  ), buttonNumber > 3 && import_react9.default.createElement(
    animated.group,
    {
    ...
    import_react9.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(4) }),
    import_react9.default.createElement("mesh", { geometry: buttonTop4Geo, material: buttonTop4Material, position: [0, -0.3, 0], ...props3.buttonTop4Props })
  ), buttonNumber > 4 && import_react9.default.createElement(
    animated.group,
    {
    ...
    import_react9.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(5) }),
    import_react9.default.createElement("mesh", { geometry: buttonTop5Geo, material: buttonTop5Material, position: [0, -0.3, 0], ...props3.buttonTop5Props })
  ));
};
var EcctrlJoystick = (0, import_react9.forwardRef)((props3, ref) => {
  ...
  return import_react9.default.createElement("div", { ref }, import_react9.default.createElement("div", { id: "ecctrl-joystick", style: joystickWrapperStyle, onContextMenu: (e) => e.preventDefault() }, import_react9.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react9.default.createElement(JoystickComponents, { ...props3 }),
    props3.children
  )), props3.buttonNumber !== 0 && import_react9.default.createElement("div", { id: "ecctrl-button", style: buttonWrapperStyle, onContextMenu: (e) => e.preventDefault() }, import_react9.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react9.default.createElement(ButtonComponents, { ...props3 }),
    props3.children
  )));
});
...
var Ecctrl = ({
  ...
  const characterRef = (0, import_react9.useRef)(null);
  const characterModelRef = (0, import_react9.useRef)();
  const characterModelIndicator = (0, import_react9.useMemo)(() => new Object3D(), []);
  ...
  const modelFacingVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyFacingVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyBalanceVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnX = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyFacingVecOnY = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnZ = (0, import_react9.useMemo)(() => new Vector3(), []);
  const vectorY = (0, import_react9.useMemo)(() => new Vector3(0, 1, 0), []);
  const vectorZ = (0, import_react9.useMemo)(() => new Vector3(0, 0, 1), []);
  const crossVecOnX = (0, import_react9.useMemo)(() => new Vector3(), []);
  const crossVecOnY = (0, import_react9.useMemo)(() => new Vector3(), []);
  const crossVecOnZ = (0, import_react9.useMemo)(() => new Vector3(), []);
  const bodyContactForce = (0, import_react9.useMemo)(() => new Vector3(), []);
  const slopeRayOriginUpdatePosition = (0, import_react9.useMemo)(() => new Vector3(), []);
  const camBasedMoveCrossVecOnY = (0, import_react9.useMemo)(() => new Vector3(), []);
  ...
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const [controllerIndex, setControllerIndex] = (0, import_react9.useState)(null);
  const gamepadKeys = { forward: false, backward: false, leftward: false, rightward: false };
  const gamepadJoystickVec2 = (0, import_react9.useMemo)(() => new Vector2(), []);
  ...
  const mergedKeys = (0, import_react9.useMemo)(() => Object.assign({}, defaultControllerKeys, controllerKeys), [controllerKeys]);
  ...
  let canJump = false;
  let isFalling = false;
  const initialGravityScale = (0, import_react9.useMemo)(() => {
    var _a;
    return (_a = props3.gravityScale) != null ? _a : 1;
  }, []);
  let massRatio = 1;
  let isOnMovingObject = false;
  const standingForcePoint = (0, import_react9.useMemo)(() => new Vector3(), []);
  const movingObjectDragForce = (0, import_react9.useMemo)(() => new Vector3(), []);
  const movingObjectVelocity = (0, import_react9.useMemo)(() => new Vector3(), []);
  const movingObjectVelocityInCharacterDir = (0, import_react9.useMemo)(() => new Vector3(), []);
  const distanceFromCharacterToObject = (0, import_react9.useMemo)(() => new Vector3(), []);
  const objectAngvelToLinvel = (0, import_react9.useMemo)(() => new Vector3(), []);
  const velocityDiff = (0, import_react9.useMemo)(() => new Vector3(), []);
  let dirLight = null;
  const cameraSetups = {
    disableFollowCam,
    disableFollowCamPos,
  ...
  const pivotPosition = (0, import_react9.useMemo)(() => new Vector3(), []);
  const pivotXAxis = (0, import_react9.useMemo)(() => new Vector3(1, 0, 0), []);
  const pivotYAxis = (0, import_react9.useMemo)(() => new Vector3(0, 1, 0), []);
  const pivotZAxis = (0, import_react9.useMemo)(() => new Vector3(0, 0, 1), []);
  const followCamPosition = (0, import_react9.useMemo)(() => new Vector3(), []);
  const modelEuler = (0, import_react9.useMemo)(() => new Euler(), []);
  const modelQuat = (0, import_react9.useMemo)(() => new Quaternion(), []);
  const moveImpulse = (0, import_react9.useMemo)(() => new Vector3(), []);
  const movingDirection = (0, import_react9.useMemo)(() => new Vector3(), []);
  const moveAccNeeded = (0, import_react9.useMemo)(() => new Vector3(), []);
  const jumpVelocityVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const jumpDirection = (0, import_react9.useMemo)(() => new Vector3(), []);
  const currentVel = (0, import_react9.useMemo)(() => new Vector3(), []);
  const currentPos = (0, import_react9.useMemo)(() => new Vector3(), []);
  const dragForce = (0, import_react9.useMemo)(() => new Vector3(), []);
  const dragAngForce = (0, import_react9.useMemo)(() => new Vector3(), []);
  const wantToMoveVel = (0, import_react9.useMemo)(() => new Vector3(), []);
  const rejectVel = (0, import_react9.useMemo)(() => new Vector3(), []);
  let floatingForce = null;
  const springDirVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const characterMassForce = (0, import_react9.useMemo)(() => new Vector3(), []);
  const rayOrigin = (0, import_react9.useMemo)(() => new Vector3(), []);
  const rayCast = new rapier.Ray(rayOrigin, rayDir);
  let rayHit = null;
  let slopeAngle = null;
  let actualSlopeNormal = null;
  let actualSlopeAngle = null;
  const actualSlopeNormalVec = (0, import_react9.useMemo)(() => new Vector3(), []);
  const floorNormal = (0, import_react9.useMemo)(() => new Vector3(0, 1, 0), []);
  const slopeRayOriginRef = (0, import_react9.useRef)();
  const slopeRayorigin = (0, import_react9.useMemo)(() => new Vector3(), []);
  ...
  const crossVector = (0, import_react9.useMemo)(() => new Vector3(), []);
  const pointToPoint = (0, import_react9.useMemo)(() => new Vector3(), []);
  const getMoveToPoint = useGame((state) => state.getMoveToPoint);
  const bodySensorRef = (0, import_react9.useRef)();
  ...
  return import_react9.default.createElement(
    ...
    isModePointToMove && import_react9.default.createElement(
      CylinderCollider,
      {
        ref: bodySensorRef,
        sensor: true,
    ...
    import_react9.default.createElement("group", { ref: characterModelRef, userData: { camExcludeCollision: true } }, import_react9.default.createElement(
      "mesh",
      {
        position: [
          rayOriginOffest.x,
      ...
      import_react9.default.createElement("boxGeometry", { args: [0.15, 0.15, 0.15] })
    ), children)
  );
};
var Ecctrl$1 = (0, import_react9.forwardRef)(Ecctrl);
export {
  EcctrlAnimation,
  EcctrlJoystick,
  Ecctrl$1 as default,
